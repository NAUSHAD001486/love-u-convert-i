...
.bg-\[\#292931\] {
  --tw-bg-opacity: 1;
  background-color: rgb(41 41 49 / var(--tw-bg-opacity, 1));
}
.bg-\[\#7C3AED\]\/10 {
...
.bg-\[\#7C3AEE\] {
  --tw-bg-opacity: 1;
  background-color: rgb(124 58 238 / var(--tw-bg-opacity, 1));
}
.bg-\[\#7C3AEE\]\/70 {
  background-color: rgb(124 58 238 / 0.7);
}
.bg-\[\#efeef3\] {
  --tw-bg-opacity: 1;
  background-color: rgb(239 238 243 / var(--tw-bg-opacity, 1));
}
.bg-\[\#ffffff\] {
  --tw-bg-opacity: 1;
...
.from-\[\#7D3CFF\] {
  --tw-gradient-from: #7D3CFF var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(125 60 255 / 0) var(--tw-gradient-to-position);
...
.to-\[\#A066FF\] {
  --tw-gradient-to: #A066FF var(--tw-gradient-to-position);
}
.to-purple-500 {
...
.shadow-\[0_18px_45px_rgba\(15\2c 23\2c 42\2c 0\.07\)\] {
  --tw-shadow: 0 18px 45px rgba(15,23,42,0.07);
  --tw-shadow-colored: 0 18px 45px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
.shadow-\[0_22px_55px_rgba\(88\2c 28\2c 135\2c 0\.35\)\] {
  --tw-shadow: 0 22px 55px rgba(88,28,135,0.35);
...
.hover\:from-\[\#6D2CE6\]:hover {
  --tw-gradient-from: #6D2CE6 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(109 44 230 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}

.hover\:to-\[\#8F55E6\]:hover {
  --tw-gradient-to: #8F55E6 var(--tw-gradient-to-position);
}
...
.hover\:shadow-\[0_20px_50px_rgba\(124\2c 58\2c 237\2c 0\.25\)\]:hover {
  --tw-shadow: 0 20px 50px rgba(124,58,237,0.25);
